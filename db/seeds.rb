...
Question.create(ask: "Hidden Falls", answer: "", assignment_id: a.id, score: 1, code: "TETON2")
Question.create(ask: "Moulton Barn", answer: "", assignment_id: a.id, score: 1, code: "TETON3")
Question.create(ask: "Teton Mountain Range", answer: "", assignment_id: a.id, score: 1, code: "TETON4")
Question.create(ask: "Snake River", answer: "", assignment_id: a.id, score: 1, code: "TETON5")
Question.create(ask: "Sagebrush", answer: "", assignment_id: a.id, score: 1, code: "TETON6")
Question.create(ask: "Pine Cone", answer: "", assignment_id: a.id, score: 1, code: "TETON7")
Question.create(ask: "Meadow of Wildflowers", answer: "", assignment_id: a.id, score: 1, code: "TETON8")
Question.create(ask: "Schwabacher's Landing", answer: "", assignment_id: a.id, score: 1, code: "TETON9")
Question.create(ask: "Log Fence", answer: "", assignment_id: a.id, score: 1, code: "TETON10")
Question.create(ask: "Park Ranger", answer: "", assignment_id: a.id, score: 1, code: "TETON11")
Question.create(ask: "Lake Dock", answer: "", assignment_id: a.id, score: 1, code: "TETON12")
Question.create(ask: "Dornan's Teepee", answer: "", assignment_id: a.id, score: 1, code: "TETON13")
Question.create(ask: "Jackson Lake", answer: "", assignment_id: a.id, score: 1, code: "TETON14")
Question.create(ask: "Chapel of the Transfiguration", answer: "", assignment_id: a.id, score: 1, code: "TETON15")
Question.create(ask: "Willow Flats", answer: "", assignment_id: a.id, score: 1, code: "TETON16")
Question.create(ask: "Signal Mountain View", answer: "", assignment_id: a.id, score: 1, code: "TETON17")
Question.create(ask: "Beaver Dam", answer: "", assignment_id: a.id, score: 1, code: "TETON18")
