...
Question.create(ask: "Third Mt Rushmore president", answer: "Jefferson", assignment_id: a.id, score: 1,code: "RUSH3")
Question.create(ask: "Fourth Mt Rushmore president", answer: "Jefferson", assignment_id: a.id, score: 1,code: "RUSH4")
